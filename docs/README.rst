...
.. |img_travis| image:: https://travis-ci.com/saltstack-formulas/rspamd-formula.svg?branch=master
   :alt: Travis CI Build Status
   :scale: 100%
   :target: https://travis-ci.com/saltstack-formulas/rspamd-formula
...
Creates the docker instance and runs the ``rspamd`` main state, ready for testing.
